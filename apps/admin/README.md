...
* [`src/admin/`](src/admin/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/admin/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `admin` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/admin/config.cljs) defaults to `true` in
...
```clj
(ns admin.example
  (:require [admin.config :as config])
