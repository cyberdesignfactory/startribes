...
* [`src/viewer/`](src/viewer/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/viewer/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `viewer` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/viewer/config.cljs) defaults to `true` in
...
```clj
(ns viewer.example
  (:require [viewer.config :as config])
